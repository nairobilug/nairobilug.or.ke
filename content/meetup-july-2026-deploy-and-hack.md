...
It's worth lingering here for a moment. Milestones aren't only about celebrating how far we've come. They're also reminders that the best journeys rarely feel extraordinary while they're happening. They become extraordinary because we chose, again and again, to continue.

![July-meetup-poster](image.png){: .image-process-large-photo}

### NextDeploy  with Yussuf Hersi

Hersi took us through the journey of building NextDeploy from the ground up—a deployment platform purpose-built for Next.js applications. He shared how the project evolved from a simple JSON-based configuration system and a React interface into a full-fledged deployment engine powered by Go. He talked about the tidious journey that is tackling the challenges of developer experience, automation, scalability and self-hosted deployments along the way.

It was a great look into the realities of building and evolving an open-source developer tool. 
...
You're invited to test [Nextdeploy](https://github.com/aynaash/NextDeploy), push it to its limits, break it, build on it and contribute. Every bug report, feature suggestion and pull request helps strengthen an open-source tool created to benefit all of us.
...
Danfold Mosongo took the stage with a session on Kernel and Defensive Ghosts, diving into concepts that immediately captured the audience's attention. From low-level system security to defensive techniques.The talk offered a small yet amusing glimpse into how systems can be understood, protected and hardened against attacks.

You could feel the curiosity in the room as attendees followed along very eager to learn more about the inner workings of operating systems and defensive security. 
...
Our host, MKU  went above and beyond offering refreshments for the mingling session of the event. Recognize the institution, the club and the lecturer that is offering the space.

We came with bitings and it made an overall great networking session. 

My friend likes to say show me a pic or else it did not happen! So a group photo is always taken so that we may always look back to how great we have been growing and look forward with hopes that we keep inspiring more folks and contributors.

![July-group-photo](image-1.png)

### August Meetup

Remember, we meet on the first Saturday of the month. Hope to see you on the 1<sup>st</sup> of August 2026.
