...
This time, I wanted to give back.  To show my appreciation. Not in a big way, but in a way I could help the community grow and keep the meet-ups going. I was still a student and I thought of a way of contributing to the community other than by giving a talk.* I had already given a talk about bash-scripting. The recording can be found [here](https://youtu.be/8XLRnMF_wY8)*. In my quest to do more, I gathered enough courage and volunteered to host the next meet up,. The  plan in mind was to  to host the next event in Mount Kenya University, Nairobi campus. This would help the community with a free venue and at the same time introduce my peers to open source and the amazing community at large. 
...
This blog is about the meetup that happened on the 6<sup>th</sup> of June 2026.
NaiLug is full of amazing people.

### What went down
Saturday afternoon, 15:00hrs, seats arranged, projector ready and mics tested. A simple set up for the event. 
...
- Building HTTP from scratch using Rust by [Daniel Muringe](https://www.linkedin.com/in/danmuringe/)
- Kubernetes Talk by [Steve Nyasimi](https://www.linkedin.com/in/steve-solomon-39ab72248/)
...
Since I was talking about how Kubernetes handles  massive workloads.  I went through some scaling concepts and how kubernetes scales. I went all _out_ honestly. I also briefly explained the concepts of high availability, fault tolerance and orchestration.  
